import { YieldRateGoStraightRateTotalForSctModel } from '@src/_workspace/models/yield-rate/YieldRateGoStraightRateTotalForSctModel'
import { getSqlWhereByColumnFilters } from '@src/helpers/getSqlWhereByFilterColumn'
import { ResponseI } from '@src/types/ResponseI'
import { Request, Response } from 'express'

export const YieldRateGoStraightRateTotalForSctController = {
  search: async (req: Request, res: Response) => {
    ...
    const result = await YieldRateGoStraightRateTotalForSctModel.search(dataItem)
  ...
  getByProductTypeIdAndFiscalYear_MasterDataLatest: async (req: Request, res: Response) => {
    ...
    const result = await YieldRateGoStraightRateTotalForSctModel.getByProductTypeIdAndFiscalYear_MasterDataLatest(dataItem)
  ...
  getByProductTypeIdAndFiscalYearAndRevisionNo: async (req: Request, res: Response) => {
    ...
    const result = await YieldRateGoStraightRateTotalForSctModel.getByProductTypeIdAndFiscalYearAndRevisionNo(dataItem)
