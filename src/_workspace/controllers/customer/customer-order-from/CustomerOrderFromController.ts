import { CustomerOrderFromModel } from '@src/_workspace/models/customer/customer-order-from/CustomerOrderFromModel'
import getSqlWhere from '@src/helpers/sqlWhere'
import { ResponseI } from '@src/types/ResponseI'
import { Request, Response } from 'express'

export const CustomerOrderFromController = {
  search: async (req: Request, res: Response) => {
    ...
    const tableIds = [
      ...
      { table: 'tb_1', id: 'CUSTOMER_ORDER_FROM_NAME', Fns: 'LIKE' },

      { table: 'tb_1', id: 'CUSTOMER_ORDER_FROM_ALPHABET', Fns: 'LIKE' },
    ...
    const result = await CustomerOrderFromModel.search(dataItem)
  ...
  create: async (req: Request, res: Response) => {
    ...
    let result = await CustomerOrderFromModel.create(dataItem)
  ...
  update: async (req: Request, res: Response) => {
    ...
    let result = await CustomerOrderFromModel.update(dataItem)
    res.status(200).json(result as ResponseI)
    // {
    //   Status: true,
  ...
  delete: async (req: Request, res: Response) => {
    ...
    let result = await CustomerOrderFromModel.delete(dataItem)
  ...
  GetByLikeCustomerOrderFromNameAndInuse: async (req: Request, res: Response) => {
    let dataItem
    ...
    let result = await CustomerOrderFromModel.getByLikeCustomerOrderFromNameAndInuse(dataItem)
