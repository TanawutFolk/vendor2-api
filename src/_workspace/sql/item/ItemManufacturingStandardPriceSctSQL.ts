export const ItemManufacturingStandardPriceSctSQL = {
  create: async (dataItem: { ITEM_M_S_PRICE_SCT_ID: string; ITEM_M_S_PRICE_ID: string; SCT_ID: string; CREATE_BY: string }) => {
    let sql = `
                INSERT INTO ITEM_M_S_PRICE_SCT
                    (
                          ITEM_M_S_PRICE_SCT_ID
                        , ITEM_M_S_PRICE_ID
                        , SCT_ID
                        , CREATE_BY
                        , UPDATE_BY
                ...
                VALUES
                    (
                          'dataItem.ITEM_M_S_PRICE_SCT_ID'
    ...
    sql = sql
      .replaceAll('dataItem.ITEM_M_S_PRICE_SCT_ID', dataItem.ITEM_M_S_PRICE_SCT_ID)
      .replaceAll('dataItem.ITEM_M_S_PRICE_ID', dataItem.ITEM_M_S_PRICE_ID)
      .replaceAll('dataItem.SCT_ID', dataItem.SCT_ID)
      .replaceAll('dataItem.CREATE_BY', dataItem.CREATE_BY)
