...
export const ReRegisterSQL = {
  ...
  updateVendor: (dataItem: any) => {
    ...
    sql = sql.replaceAll('dataItem.MASTER_VENDOR_TYPES_ID', ReRegisterSQL.toNullableNumberSql(dataItem['MASTER_VENDOR_TYPES_ID']))
    sql = sql.replaceAll('dataItem.VENDOR_REGION', dataItem['VENDOR_REGION'] || 'Local')
    sql = sql.replaceAll('dataItem.PROVINCE_SQL', ReRegisterSQL.toNullableStringSql(dataItem['PROVINCE']))
    sql = sql.replaceAll('dataItem.POSTAL_CODE_SQL', ReRegisterSQL.toNullableStringSql(dataItem['POSTAL_CODE']))
    sql = sql.replaceAll('dataItem.COUNTRY_SQL', ReRegisterSQL.toNullableStringSql(dataItem['COUNTRY']))
