export const OrderTypeSQL = {
  search: async (dataItem: any) => {
    ...
    sql = sql.replaceAll('dataItem.ORDER_TYPE_NAME', dataItem['ORDER_TYPE_NAME'])
    sql = sql.replaceAll('dataItem.ORDER_TYPE_ALPHABET', dataItem['ORDER_TYPE_ALPHABET'])
    ...
    sql = `
                    SELECT
                        tb_1.ORDER_TYPE_ID
                      , tb_1.ORDER_TYPE_NAME
                      , tb_1.ORDER_TYPE_ALPHABET
                      , tb_1.UPDATE_BY
  ...
  getByOrderTypeNameOrOrderTypeAlphabetAndInuse: async (dataItem: any, sqlWhere: any) => {
    let sql = `  SELECT
                      ORDER_TYPE_ID
                    , ORDER_TYPE_NAME
                    , ORDER_TYPE_ALPHABET
                ...
                OR ORDER_TYPE_ALPHABET = 'dataItem.ORDER_TYPE_ALPHABET' )
                AND INUSE = 1
                dataItem.sqlWhere
  ...
  create: async (dataItem: any) => {
    let sql = `      INSERT INTO ORDER_TYPE
                    (
                          ORDER_TYPE_ID
                        , ORDER_TYPE_NAME
                        , ORDER_TYPE_ALPHABET
                        ...
                        SELECT
                            1 + coalesce((SELECT max(ORDER_TYPE_ID) FROM ORDER_TYPE), 0)
  ...
  getByOrderTypeNameAndInuse: async (dataItem: any) => {
    let sql = `  SELECT
                      ORDER_TYPE_ID
                    , ORDER_TYPE_NAME
                    , ORDER_TYPE_ALPHABET
  ...
  getByOrderTypeAlphabetAndInuse: async (dataItem: any) => {
    let sql = `  SELECT
                      ORDER_TYPE_ID
                    , ORDER_TYPE_NAME
                    , ORDER_TYPE_ALPHABET
