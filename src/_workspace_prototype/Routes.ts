...
import bomPivotingRoutes from './routes/bom-pivoting/BomPivotingRoutes'
...
import costConditionSettingRoutes from './routes/cost-condition/CostConditionSettingRoutes'
...
import sctPivotingRoutes from './routes/sct-pivoting/SctPivotingRoutes'
...
Routers.use('/bom-pivoting', bomPivotingRoutes)
Routers.use('/sct-pivoting', sctPivotingRoutes)
...
Routers.use('/cost-condition/cost-condition-setting', costConditionSettingRoutes)
