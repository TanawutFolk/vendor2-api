  ...
  create: async (dataItem: any) => {
    ...
    if (resultData.length === 0) {
      ...
      if (resultDataAlphabet.length === 0) {
        ...
        // Loc
        dataItem.TOTAL_COUNT_LOC = dataItem.LOC.length
        sqlList.push(await ProductMainLocSQL.createProductMainLocHeaderByProductMainId(dataItem))
  ...
  update: async (dataItem: any) => {
    ...
    if (resultData.length === 0 || (resultData.length !== 0 && resultData[0].PRODUCT_MAIN_ID === dataItem.PRODUCT_MAIN_ID)) {
      ...
      if (resultDataAlphabet.length === 0 || (resultDataAlphabet.length !== 0 && resultDataAlphabet[0].PRODUCT_MAIN_ID === dataItem.PRODUCT_MAIN_ID)) {
        ...
        sqlList.push(await ProductMainLocSQL.updateProductMainLocHeaderByProductMainId(dataItem))
        dataItem.TOTAL_COUNT_LOC = dataItem.LOC.length
        sqlList.push(await ProductMainLocSQL.createProductMainLocHeaderByProductMainIdAfterUpdate(dataItem))
