export const ItemManufacturingSQL = {
  ...
  getIsCurrentByItemId: async (dataItem: any) => {
    let sql = `            SELECT
                                IS_CURRENT
                           FROM
                                ITEM_MANUFACTURING
  ...
  getPurchaseUnitCodeByItemId: async (dataItem: any) => {
    let sql = `            SELECT
                                tb_3.SYMBOL AS PURCHASE_UNIT_CODE
                           FROM
                                ITEM_MANUFACTURING tb_1
                                 LEFT JOIN
                                UNIT_OF_MEASUREMENT tb_2
                                    ON tb_1.USAGE_UNIT_ID = tb_2.UNIT_OF_MEASUREMENT_ID
                                 LEFT JOIN
                                UNIT_OF_MEASUREMENT tb_3
                                    ON tb_1.PURCHASE_UNIT_ID = tb_3.UNIT_OF_MEASUREMENT_ID
                          WHERE
  ...
  getUsageUnitCodeByItemId: async (dataItem: any) => {
    let sql = `            SELECT
                                tb_2.SYMBOL AS USAGE_UNIT_CODE
                           FROM
                                ITEM_MANUFACTURING tb_1
                                 LEFT JOIN
                                UNIT_OF_MEASUREMENT tb_2
  ...
  getUsageUnitRatioByItemId: async (dataItem: any) => {
    let sql = `            SELECT
  ...
  getVersionNoByItemId: async (dataItem: any) => {
    let sql = `            SELECT
                                tb_1.VERSION_NO
                           FROM
                                ITEM_MANUFACTURING tb_1
  ...
  getItemCodeByItemCode: async (dataItem: any) => {
    let sql = `            SELECT
