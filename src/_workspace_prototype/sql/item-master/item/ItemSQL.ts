export const ItemSQL = {
  ...
  getByLikeItemCodeAndInuseAndNotFGSemiFGSubAs: async (dataItem: any) => {
    let sql = `     SELECT
                    ...
                    ORDER BY
                        CASE
                            WHEN tb_1.ITEM_CODE_FOR_SUPPORT_MES = 'dataItem.ITEM_CODE' THEN 1
                            WHEN tb_1.ITEM_CODE_FOR_SUPPORT_MES LIKE 'dataItem.ITEM_CODE%' THEN 2
                            WHEN tb_1.ITEM_CODE_FOR_SUPPORT_MES LIKE '%dataItem.ITEM_CODE%' THEN 2
                            ELSE 4
                        END,
                        tb_1.ITEM_CODE_FOR_SUPPORT_MES
...
`
  ...
  updateInuseByItemId: async (dataItem: any) => {
    let sql = `         UPDATE
                                ITEM
                        SET
                                INUSE = '0'
