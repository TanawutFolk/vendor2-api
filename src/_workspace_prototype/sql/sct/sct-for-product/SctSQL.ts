export const SctSQL = {
  ...
  getItemPrice: async (dataItem: any) => {
    let sql = `
                SELECT
           ...
           FROM
                ...
                WHERE
                    ...
                    AND tb_2.PURCHASE_PRICE = 'dataItem.PURCHASE_PRICE'
                    AND tb_2.PURCHASE_PRICE_CURRENCY_ID = 'dataItem.PURCHASE_PRICE_CURRENCY_ID'
                    AND tb_2.PURCHASE_PRICE_UNIT_ID = 'dataItem.PURCHASE_PRICE_UNIT_ID'
                    AND tb_3.VERSION_NO ='dataItem.VERSION_NO'
                    AND tb_10.SYMBOL = 'dataItem.USAGE_UNIT_CODE'
                    AND tb_1.USAGE_UNIT_RATIO = 'dataItem.USAGE_UNIT_RATIO'
                    AND tb_11.SYMBOL = 'dataItem.PURCHASE_UNIT_CODE'
                    AND tb_1.INUSE = 1
                    AND tb_2.INUSE =1
    ...
    sql = sql.replaceAll('dataItem.USAGE_UNIT_CODE', dataItem.USAGE_UNIT_CODE)
    sql = sql.replaceAll('dataItem.PURCHASE_UNIT_CODE', dataItem.PURCHASE_UNIT_CODE)
    sql = sql.replaceAll('dataItem.PURCHASE_PRICE_CURRENCY_ID', dataItem.PURCHASE_PRICE_CURRENCY_ID)

    sql = sql.replaceAll('dataItem.PURCHASE_PRICE', dataItem.PURCHASE_PRICE)
    sql = sql.replaceAll('dataItem.VERSION_NO', dataItem.VERSION_NO)
