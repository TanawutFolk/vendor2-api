export const YieldRateAndGoStraightRateSQL = {
  ...
  updateYieldRateProcessIsCurrent: async (dataItem: any) => {
    let sql = `
            UPDATE YIELD_RATE_GO_STRAIGHT_RATE_PROCESS_FOR_SCT
            SET IS_CURRENT = 0
            WHERE FISCAL_YEAR = 'dataItem.FISCAL_YEAR'
  ...
  updateYieldRateTotalIsCurrent: async (dataItem: any) => {
    let sql = `
            UPDATE YIELD_RATE_GO_STRAIGHT_RATE_TOTAL_FOR_SCT
            SET IS_CURRENT = 0
            WHERE FISCAL_YEAR = 'dataItem.FISCAL_YEAR'
            AND PRODUCT_TYPE_ID = 'dataItem.PRODUCT_TYPE_ID'
            AND INUSE = 1
