...
export const StandardCostForProductSQL = {
  ...
  search: async (dataItem: any) => {
    let sql = `         WITH base AS (
                                        ...
                                        , tb_2.UPDATE_DATE       AS STATUS_UPDATE_DATE
                                        , tb_1.CANCEL_REASON
                                        , tb_1.NOTE
                                        , tb_1.DESCRIPTION
                                        , tb_1.INUSE
                                        ...
                                        , IF(tb_22.SELLING_PRICE IS NULL OR tb_2.SCT_STATUS_PROGRESS_ID = 2,
                                          '', tb_22.UPDATE_DATE) AS RE_CAL_UPDATE_DATE
                                        , IF(tb_22.SELLING_PRICE IS NULL OR tb_2.SCT_STATUS_PROGRESS_ID = 2,
                                        ...
                                        , tb_22.GA_FOR_SELLING_PRICE
                                        , tb_22.SELLING_EXPENSE_FOR_SELLING_PRICE
                                        , tb_22.MARGIN_FOR_SELLING_PRICE
                                        , tb_22.CIT_FOR_SELLING_PRICE
                                        , IF(tb_2.SCT_STATUS_PROGRESS_ID = 2, NULL, tb_22.SELLING_PRICE_BY_FORMULA) AS SELLING_PRICE_BY_FORMULA
                                        , tb_22.REMARK_FOR_ADJUST_PRICE
                                        , tb_22.TOTAL AS 'TOTAL_DIRECT_COST'
...
, IF(tb_22.SELLING_PRICE IS NULL OR tb_2.SCT_STATUS_PROGRESS_ID = 2 , '', tb_22.UPDATE_BY) AS RE_CAL_UPDATE_BY
  ...
  getParentProductTypeBySctRevisionCode: async (dataItem: { SCT_REVISION_CODE: string; sqlWhere: string }) => {
    let sql = `
                                SELECT
                                          tb_5.SCT_ID
