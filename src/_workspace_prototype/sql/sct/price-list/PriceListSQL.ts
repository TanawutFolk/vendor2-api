export const PriceListExportSQL = {
  exportToFile: async (dataItem: any) => {
    let sql = `  SELECT DISTINCT
                ...
                LEFT JOIN dataItem.STANDARD_COST_DB.SCT_REASON_HISTORY tb_12 ON tb_1.SCT_ID = tb_12.SCT_ID AND tb_12.INUSE = 1
                LEFT JOIN dataItem.STANDARD_COST_DB.SCT_REASON_SETTING tb_13 ON tb_12.SCT_REASON_SETTING_ID = tb_13.SCT_REASON_SETTING_ID
