export const YieldRateSQL = {
  search: async (dataItem: any, sqlWhere: any) => {
    ...
    let sql = `  SELECT COUNT(*) AS TOTAL_COUNT
                ...
                LEFT JOIN dataItem.STANDARD_COST_DB.SCT_REASON_SETTING tb_9 ON tb_9.SCT_REASON_SETTING_ID = tb_5.SCT_REASON_SETTING_ID
    ...
    sql = `         SELECT
                    ...
                    , tb_5.INUSE
                    , tb_5.YIELD_RATE_GO_STRAIGHT_RATE_PROCESS_FOR_SCT_ID
                    , tb_11.CUSTOMER_INVOICE_TO_ID
  ...
  searchYieldRateProcessUnlimit: async (dataItem: any, sqlWhere: any) => {
    let sqlList: any = []
  ...
  searchTotal: async (dataItem: any, sqlWhere: any) => {
    ...
    sql = `  SELECT  tb_1.PRODUCT_CATEGORY_ID
                    ...
                    , DATE_FORMAT(tb_5.UPDATE_DATE, '%d-%b-%Y %H:%i:%s' ) AS MODIFIED_DATE
                    , tb_5.INUSE
                    , tb_5.YIELD_RATE_GO_STRAIGHT_RATE_TOTAL_FOR_SCT_ID
                    , tb_11.CUSTOMER_INVOICE_TO_ID
                    , tb_11.CUSTOMER_INVOICE_TO_NAME
                    , tb_13.ITEM_CATEGORY_ID
                    , tb_13.ITEM_CATEGORY_NAME
  ...
  searchYieldRateTotalUnlimit: async (dataItem: any, sqlWhere: any) => {
    let sqlList: any = []
