import { IndirectCostConditionModel } from '@src/_workspace/models/cost-condition/IndirectCostConditionModel'
import { getSqlWhereByColumnFilters_elysia } from '@src/helpers/getSqlWhereByFilterColumn'
import { ResponseI } from '@src/types/ResponseI'
import { Request, Response } from 'express'

export const IndirectCostConditionController = {
  search: async (req: Request, res: Response) => {
    ...
    const tableIds = [
      ...
      { table: 'tb_1', id: 'LABOR' },
      { table: 'tb_1', id: 'DEPRECIATION' },
      { table: 'tb_1', id: 'OTHER_EXPENSE' },
      { table: 'tb_1', id: 'TOTAL_INDIRECT_COST' },
    ...
    let result = await IndirectCostConditionModel.search(dataItem)
  ...
  create: async (req: Request, res: Response) => {
    ...
    let result = await IndirectCostConditionModel.create(dataItem)
  ...
  getByProductMainIdAndFiscalYearAndItemCategoryId_MasterDataLatest: async (req: Request, res: Response) => {
    ...
    const result = await IndirectCostConditionModel.getByProductMainIdAndFiscalYearAndItemCategoryId_MasterDataLatest(dataItem)
  ...
  getByProductMainIdAndFiscalYearAndItemCategoryIdAndRevisionNo: async (req: Request, res: Response) => {
    ...
    const result = await IndirectCostConditionModel.getByProductMainIdAndFiscalYearAndItemCategoryIdAndRevisionNo(dataItem)
  ...
  getIndirectCostConditionByIndirectCostConditionId: async (req: Request, res: Response) => {
    let dataItem
    ...
    const result = await IndirectCostConditionModel.getIndirectCostConditionByIndirectCostConditionId(dataItem)
