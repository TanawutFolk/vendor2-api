import { SpecialCostConditionModel } from '@src/_workspace/models/cost-condition/SpecialCostConditionModel'
import { getSqlWhereByColumnFilters_elysia } from '@src/helpers/getSqlWhereByFilterColumn'
import { ResponseI } from '@src/types/ResponseI'
import { Request, Response } from 'express'

export const SpecialCostConditionController = {
  search: async (req: Request, res: Response) => {
    ...
    let result = await SpecialCostConditionModel.search(dataItem)
  ...
  create: async (req: Request, res: Response) => {
    ...
    let result = await SpecialCostConditionModel.create(dataItem)
  ...
  getAdjustPrice: async (req: Request, res: Response) => {
    let dataItem
    ...
    let result = await SpecialCostConditionModel.getAdjustPrice(dataItem)
  ...
  getByProductMainIdAndFiscalYearAndItemCategoryId_MasterDataLatest: async (req: Request, res: Response) => {
    ...
    const result = await SpecialCostConditionModel.getByProductMainIdAndFiscalYearAndItemCategoryId_MasterDataLatest(dataItem)
  ...
  getByProductMainIdAndFiscalYearAndItemCategoryIdAndRevisionNo: async (req: Request, res: Response) => {
    ...
    const result = await SpecialCostConditionModel.getByProductMainIdAndFiscalYearAndItemCategoryIdAndRevisionNo(dataItem)
