...
export const IndirectCostConditionModel = {
  ...
  getIndirectCostConditionByIndirectCostConditionId: async (dataItem: any) => IndirectCostConditionService.getIndirectCostConditionByIndirectCostConditionId(dataItem),
}
