...
CREATE TABLE request_vendor_gpr_c_circular_members (
    REQUEST_VENDOR_GPR_C_CIRCULAR_MEMBERS_ID BIGINT NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (REQUEST_VENDOR_GPR_C_CIRCULAR_MEMBERS_ID),
    UNIQUE KEY uq_gpr_c_circular_member_order (REQUEST_VENDOR_SELECTIONS_ID, MEMBER_ORDER),
...
SELECT
    s.REQUEST_VENDOR_SELECTIONS_ID,
...
CREATE TABLE request_vendor_gpr_c_action_setup (
    REQUEST_VENDOR_GPR_C_ACTION_SETUP_ID BIGINT NOT NULL AUTO_INCREMENT,
    REQUEST_VENDOR_SELECTIONS_ID INT NOT NULL,
    ...
    UPDATE_BY VARCHAR(50) NULL,
    UPDATE_DATE DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (REQUEST_VENDOR_GPR_C_ACTION_SETUP_ID),
    UNIQUE KEY uq_gpr_c_action_setup_stage (REQUEST_VENDOR_SELECTIONS_ID, STAGE_CODE),
